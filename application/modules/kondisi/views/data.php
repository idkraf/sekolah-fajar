	...
	<section class="content">
        ...
        <div class="box shadow-sm border-bottom-primary">
            <div class="card-body table-responsive">
                <table class="table table-striped" id="kondisi">
                    <thead>
                        <tr>
                            <th>No. </th>
                            <th>Nama</th>
...
<div id="delete_model" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('manage/kondisi/delete/'); ?>
    ...
    $(document).ready(function () {
        ...
        function draw_data() {
            $('#kondisi').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('manage/kondisi/ajax_list') ?>",
                    'type': 'POST',
                    'data': {
                ...
                buttons: [                    
                    {
                        ...
                        action: function ( e, dt, node, config ) {
							...
							window.location = '<?php echo site_url('manage/kondisi/add') ?>'
                        }
                    },
                    {
                        extend: 'excelHtml5',
