...
class Supplier_set extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Supplier_model', 'admin');
    ...
    if ($getId == NULL) {
            ...
            $input = $this->input->post(null, true);
             if (@$_FILES['foto']['name'] != null) {
                ...
                $save = $this->admin->insert('supplier', $input);
                    ...
                    redirect('manage/supplier');
                }else{
                    $error = $this->upload->display_errors();
                    $this->session->set_flashdata('error', $error);
                    redirect('manage/supplier/add');
                }
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (empty($_FILES['foto']['name'])) {
                ...
                redirect('manage/supplier/edit'.$id);
            } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['main'] = 'supplier/supplier_edit';
            $this->load->view('manage/layout', $data);
        } else {
            $input = $this->input->post(null, true);
            if (empty($_FILES['foto']['name'])) {
