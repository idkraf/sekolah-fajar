...
class Inventoriin_model extends CI_Model {

    var $table = 'inventori_masuk';
    var $order = array('id_barang_masuk' => 'desc');
    var $column_search = array('nama_barang');

    private function _get_datatables_query() {
        
        $this->db->join('users u', 'inventori_masuk.user_id = u.user_id');
        $this->db->join('isupplier sp', 'inventori_masuk.supplier_id = sp.id_supplier');
        $this->db->join('inventori b', 'inventori_masuk.barang_id = b.id_barang');
    ...
    public function count_all() {
        $this->db->select('inventori_masuk.id_barang_masuk');
        $this->db->from($this->table);
