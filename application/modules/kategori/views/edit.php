            ...
            <div class="col-md-8">
                <div class="box shadow-sm border-bottom-primary">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open('', [], ['idkategori' => $kategori['idkategori']]); ?>
                        <div class="row form-group">
                            <label class="col-md-3 text-md-right" for="nama_kategori">Nama Kategori</label>
                            <div class="col-md-9">
                                <input value="<?= set_value('nama_kategori', $kategori['nama_kategori']); ?>" name="nama_kategori" id="nama_kategori" type="text" class="form-control" placeholder="Nama...">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <input value="<?= set_value('keterangan', $kategori['keterangan']); ?>" name="keterangan" id="keterangan" type="text" class="form-control" placeholder="keterangan...">
