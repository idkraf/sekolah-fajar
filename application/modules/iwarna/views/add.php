        ...
        <div class="box shadow-sm border-bottom-primary">
            <div class="box-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('manage/iwarna') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="box-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_warna'); ?>" name="nama_warna" id="nama_warna" type="text" class="form-control" placeholder="Nama Warna...">
