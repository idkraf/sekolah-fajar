        ...
        <div class="box shadow-sm border-bottom-primary">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                            Item Warna Edit Form
                        </h4>
                    </div>
                    <div class="col-auto">
                        <a href="<?= base_url('manage/warna') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_warna', $warna['nama_warna']); ?>" name="nama_warna" id="nama_warna" type="text" class="form-control" placeholder="Nama Warna...">
