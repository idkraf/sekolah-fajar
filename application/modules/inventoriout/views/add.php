            ...
            <div class="col-md-8">
                <div class="box shadow-sm border-bottom-primary">
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                                    Outgoing Goods Input Form
                                </h4>
                            </div>
                            <div class="col-auto">
                                <a href="<?= base_url('manage/inventoriout') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                                    <span class="icon">
                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('', [], ['id_barang_keluar' => $id_barang_keluar, 'user_id' => $this->session->userdata('uid')]); ?>
