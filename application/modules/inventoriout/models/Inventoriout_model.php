...
class Inventoriout_model extends CI_Model {

    var $table = 'inventori_keluar';
    var $order = array('id_barang_keluar' => 'desc');
    var $column_search = array('nama_barang');

    private function _get_datatables_query() {
        
        $this->db->join('users u', 'inventori_keluar.user_id = u.user_id');
        $this->db->join('inventori b', 'inventori_keluar.barang_id = b.id_barang');
    ...
    public function count_all() {
        $this->db->select('inventori_keluar.id_barang_keluar');
        $this->db->from($this->table);
