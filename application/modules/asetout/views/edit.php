            ...
            <div class="col-md-8">
                <div class="box shadow-sm border-bottom-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('', [], ['idbarang_keluar' => $asetout['idbarang_keluar']]); ?>
                        
                        <div class="form-group">
                            <label for="tanggal">Tanggal<span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="tanggal" name="tanggal"
                                value="<?= $asetout['tanggal'] ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="barang_id" id="barang_id" class="form-control select2" style="width:100%;"
                                ...
                                <?php foreach ($aset as $s) : ?>
                                    <option <?= $asetout['barang_id'] == $s['idbarang'] ? 'selected' : ''; ?> value="<?= $s['idbarang'] ?>"><?= $s['nama_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?= set_value('jumlah', $asetout['jumlah']); ?>" type="text" class="form-control uang" id="jumlah" name="jumlah" required>
                            <?= form_error('jumlah', '<small class="text-danger">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="keterangan">Keterangan <span class="text-danger">*</span></label>
                            <textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control"
                                required><?= set_value('keterangan', $asetout['keterangan']); ?></textarea>
