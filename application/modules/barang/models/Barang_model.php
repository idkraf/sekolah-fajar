...
class Barang_model extends CI_Model
{
    ...
    private function _get_datatables_query() {
        ...
        $this->db->select('barang.*, s.nama_satuan, g.nama_gudang, j.nama_jenis, w.nama_warna, r.nama_rasa, m.nama_merek');

        $this->db->join('jenis j', 'j.id_jenis = barang.jenis_id');
        $this->db->join('warna w', 'w.id_warna = barang.warna_id');
        $this->db->join('rasa r', 'r.id_rasa = barang.rasa_id');
        $this->db->join('merek m', 'm.id_merek= barang.merek_id');
        $this->db->join('satuan s', 's.id_satuan = barang.satuan_id');
        $this->db->join('gudang g', 'g.id_gudang = barang.gudang_id');
    ...
    public function getBarang()
    {
        ...
        $this->db->join('warna w', 'b.warna_id = w.id_warna');
