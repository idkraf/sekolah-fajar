...
class Jabatan_set extends CI_Controller {
  ...
  public function __construct()
  {
    ...
    $this->load->model(array('pegawai/Pegawai_model', 'pegawai/Jabatan_model', 'setting/Setting_model'));
  ...
  public function index($offset = NULL) {
    ...
    $data['main'] = 'pegawai/jabatan_list';
