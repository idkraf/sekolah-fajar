			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body table-responsive">
						...
						<p>Penginputan data Pegawai bisa dilakukan dengan mengcopy data dari file Ms. Excel. Format file excel harus sesuai kebutuhan aplikasi. Silahkan download formatnya <a href="<?php echo site_url('manage/pegawai/download');?>"><span class="label label-success">Disini</span></a>
							<br><br>
						...
						<div class="form-group">
							...
							<a href="<?php echo site_url('manage/pegawai') ?>" class="btn btn-info btn-sm btn-flat">Kembali</a>
						</div>
						<?php echo form_close() ?>
