...
class Asetout_model extends CI_Model {
    public function getAsetKeluar($limit = null, $id_barang = null, $range = null)
    {
        ...
        $this->db->order_by('idbarang_keluar', 'DESC');
        return $this->db->get('aset_keluar x')->result_array();
    }
