...
class Item_set extends CI_Controller {
  ...
  public function __construct() {
    ...
    $this->load->model(array('item/Item_model', 'student/Student_model', 'period/Period_model', 'pos/Pos_model', 'bulan/Bulan_model', 'bebas/Bebas_model', 'bebas/Bebas_pay_model', 'logs/Logs_model'));
  ...
  public function index($offset = NULL) {
    ...
    $config['total_rows'] = count($this->Item_model->get($paramsPage));
  ...
  {    
    if ($_POST == TRUE) {
      ...
      $params['item_id'] = $id; 
      $params['item_majors_id'] = $posId; 
      $params['item_name'] = $posName;
      $this->Item_model->update($params);
    }
  ...
  {    
    if ($_POST == TRUE) {
      $posId = $_POST['item_majors_id'];
      $posName = $_POST['item_name'];
      $cpt = count($_POST['item_name']);
      
      $params['item_majors_id'] = $posId; 
      for ($i = 0; $i < $cpt; $i++) {
        $params['item_name'] = $posName[$i];
