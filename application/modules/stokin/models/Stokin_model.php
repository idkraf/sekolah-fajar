...
class Stokin_model extends CI_Model {
    ...
    var $order = array('id_barang_masuk' => 'desc');
    var $column_search = array('nama_barang');

    private function _get_datatables_query() {
        
        $this->db->join('users u', 'barang_masuk.user_id = u.user_id');
        $this->db->join('supplier sp', 'barang_masuk.supplier_id = sp.id_supplier');
    ...
    public function count_all() {
        $this->db->select('barang_masuk.id_barang_masuk');
        $this->db->from($this->table);
