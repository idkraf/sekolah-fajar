            ...
            <div class="card-header bg-white py-3">
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('manage/stokin/add') ?>" class="btn btn-sm btn-primary btn-icon-split">
                                <span class="icon">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?= $bm['user_full_name']; ?></td>
                                    <td>
                                        <a onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('manage/stokin/delete/') . $bm['id_barang_masuk'] ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
