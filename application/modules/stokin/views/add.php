                ...
                <div class="box shadow-sm border-bottom-primary">
                    <div class="card-header bg-white py-3">
                        <div class="row">
                            ...
                            <!--
                            <div class="col-auto">
                                <a href="<//?= base_url('manage/stokin') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                                    <span class="icon">
...
-->
                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('', [], ['id_barang_masuk' => $id_barang_masuk, 'user_id' => $this->session->userdata('uid')]); ?>
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <a class="btn btn-primary" href="<?= base_url('manage/supplier/add'); ?>"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <a class="btn btn-primary" href="<?= base_url('manage/barang/add'); ?>"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
