...
<body>
  ...
  <div class="row">
    <div class="col-md-5">
      ...
      <p class="merk"><span style="color: #2ABB9B">SISTEM INFORMASI</span> </p> 
      <?php if (isset($setting_school) AND $setting_school['setting_value'] == '-') { ?>
      <p class="school">Sistem Informasi</p> 
      <?php } else { ?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>NIP</label>
                <input type="text" required="" autofocus="" name="nip" placeholder="Masukan NIP" class="form-control flat">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
